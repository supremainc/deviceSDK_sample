...
<Badge only>+ v2.7.2</Badge> Transfers user information mapped to the card or user ID authentication results to the device.

This API includes FaceStation F2 support.
