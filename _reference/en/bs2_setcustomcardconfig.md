...
<Badge only>+ v2.9.4</Badge> Stores Custom smart card settings.

:::warning

**Warning**

To use the custom smart card function, you must disable suprema smart card modes and enable custom smart card modes in useCardOperationMask of [BS2SystemConfig](configuration_api#bs2systemconfig).
...
:::info"\> [See to structure BS2CustomCardConfig](configuration api#BS2CustomCardConfig) 
...
- \[Out\] `config` : Pointer to set Custom smart card information
