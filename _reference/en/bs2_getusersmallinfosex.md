...
The only difference between [BS2_GetUserInfosEx](bs2_getuserinfosex) which is using structure [BS2UserBlob](user_management_api#bs2userblob) is that the 3rd parameter BS2UserPhoto of BS2UserSmallBlobEx is using pointer for efficient memory use.
