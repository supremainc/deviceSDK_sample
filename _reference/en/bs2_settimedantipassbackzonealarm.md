...
Configures the alarm status of the timed Anti Passback zone.
...
- \[In\] `zoneIds` : List of timed Anti Passback zone IDs

- \[In\] `zoneIdCount` : Number of timed Anti Passback zone IDs
