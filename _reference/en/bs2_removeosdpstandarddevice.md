...
<Badge only>+ v2.9.1</Badge> `CoreStation40` Remove the OSDP device in batches by specifying the OSDP device identifier and number.
...
- \[In\] `osdpDeviceIds` : OSDP Device Identifier array pointer to remove
