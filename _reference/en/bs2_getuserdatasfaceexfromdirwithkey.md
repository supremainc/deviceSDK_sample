...
int BS2_GetUserDatasFaceExFromDirWithKey(void* context, const char* szDir, char* uids, uint32_t uidCount, BS2UserFaceExBlob* userBlob, BS2_USER_MASK userMask, const BS2EncryptKey* key);
```
...
[BS2_GetUserInfosFaceExFromDirWithKey](bs2_getuserinfosfaceexfromdirwithkey)
