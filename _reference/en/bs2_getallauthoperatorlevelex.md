...
<Badge only>+ v2.6.3</Badge> Gets all device operators.
...
The operatorlevelObj variable needs to return the memory to the system by the [BS2_ReleaseObject](bs2_releaseobject) function after being used.  
...
==== See Also ==== [BS2_GetAuthOperatorLevelEx](bs2_getauthoperatorlevelex)
