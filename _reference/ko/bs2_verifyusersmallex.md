...
<Badge only>+ v2.6.3</Badge> 카드나 User ID의 인증 결과와 맵핑된 유저 정보를 단말기로 전송합니다.

[BS2UserBlobEx](user_management_api#bs2userblobex)을 이용하는 [BS2_VerifyUserEx](bs2_verifyuserex)와의 차이는
