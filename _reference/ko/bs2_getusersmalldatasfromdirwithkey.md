...
<Badge only>+ v2.8.2</Badge> USB로 추출한 Data에서 UserMask에 맞게 사용자 ID의 정보를 가져옵니다.

[BS2UserBlob](user_management_api#bs2userblob)을 이용하는 [BS2_GetUserDatasFromDirWithKey](bs2_getuserdatasfromdirwithkey)와의 차이는
