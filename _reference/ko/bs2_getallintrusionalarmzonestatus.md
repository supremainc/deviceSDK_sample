...
int BS2_GetAllIntrusionAlarmZoneStatus(void* context, BS2_DEVICE_ID deviceId, BS2ZoneStatus** zoneStatusObj, uint32_t* numZoneStatus);
```
...
- \[In\] `zoneIds` : 가져오고자 하는 경비 경보 구역 id 리스트

- \[In\] `zoneIdCount` : 경비 경보 구역 id 리스트의 크기
