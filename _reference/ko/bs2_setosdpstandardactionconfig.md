...
<Badge only>+ v2.9.1</Badge> OSDP 장치의 action별 LED/buzzer 설정을 저장합니다.
...
:::info"\> [BS2OsdpStandardActionConfig 구조체 보기](configuration api#BS2OsdpStandardActionConfig) 
...
- \[Out\] `config` : OSDP 장치의 LED/buzzer 정보를 취득할 포인터
