...
:::info
 ...
 [BS2DoorStatus 구조체 보기](door control api#BS2DoorStatus) 
...
- \[Out\] `doorStatusObj` : door status 리스트를 저장할 포인터

- \[Out\] `numDoorStatus` : door status 리스트의 개수

  **참고**

doorStatusObj 변수는 사용한 뒤 [BS2_ReleaseObject](bs2_releaseobject) 함수를 이용해 시스템에 메모리를 반환해야 합니다.  
