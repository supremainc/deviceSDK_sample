...
:::info
 ...
 [BS2LiftStatus구조체 보기](lift control api#BS2LiftStatus) 
...
liftStatusObj 변수는 사용한 뒤 [BS2_ReleaseObject](bs2_releaseobject) 함수를 이용해 시스템에 메모리를 반환해야 합니다.  
