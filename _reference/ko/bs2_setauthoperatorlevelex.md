...
<Badge only>+ v2.6.3</Badge> 장치관리자를 추가합니다.
...
BS2 1.8.0, A2 1.7.0, L2 1.5.0, N2 1.2.0, FS 1.3.0, FaceLite 1.0.1, CS40 1.3.0, P2 1.3.0, W2 1.4.0, Xpass 2 1.0.0 + 3Q 2019 이후 출시된 2세대 제품
...
- \[In\] `operatorlevels` : 장치에 추가할 관리자 리스트

- \[In\] `operatorlevelCount` : 장치에 추가할 관리자 수
